...
![Que no te falte el aire]({{ site.baseurl }}/imgs/escuelita-covid.jpeg "Entrenamiento semanal de la escuelita")
...
![Que no te falte el aire]({{ site.baseurl }}/imgs/bandera-escuelita.png "Bandera escuelita")